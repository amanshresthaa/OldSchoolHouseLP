window.ELEGANT_MENU_DATA = {
  ...
  mixedGrillsIntro: "Swap chicken wings for crispy wings on any grill.",
  curriesIntro: "Choose your curry style from the column headings below.",
  biryaniIntro:
    "Well seasoned one pot dish, made by layering fragrant basmati rice.",
  pubGrubIntro: "Served with chips, salad, mayo and sweet chilli sauce.",
  kidsIntro: "Choose chips or rice.",
  starters: [
    ...
    { name: "Chilli Mogo", price: "5.25", labels: ["veg", "GF", "spice-2"] },
    { name: "Chilli Paneer", price: "6.25", labels: ["veg", "GF", "spice-2"] },
  ...
  crisp: [
    { name: "Honey Chilli Chicken", price: "6.75", labels: ["GF", "spice-2"] },
  ...
  curries: {
    curry: [
      { name: "Veg", price: "10.00", labels: ["veg", "GF"] },
      { name: "Chicken", price: "11.00", labels: ["GF"] },
      { name: "Lamb", price: "12.00", labels: ["GF"] },
      { name: "King Prawn", price: "14.00", labels: ["GF"] },
    ],
    korma: [
      { name: "Veg", price: "11.00", labels: ["veg", "GF"] },
      { name: "Chicken", price: "12.00", labels: ["GF"] },
      { name: "Lamb", price: "13.00", labels: ["GF"] },
      { name: "King Prawn", price: "15.00", labels: ["GF"] },
    ],
    masala: [
      { name: "Veg", price: "12.00", labels: ["veg", "GF"] },
      { name: "Chicken", price: "13.00", labels: ["GF"] },
      { name: "Lamb", price: "14.00", labels: ["GF"] },
      { name: "King Prawn", price: "16.00", labels: ["GF"] },
    ],
    baltiKarahiBhunaSaagDhansakJalfreziMadrasVindalooPhaal: [
      { name: "Veg", price: "11.00", labels: ["veg", "GF"] },
      { name: "Chicken", price: "12.00", labels: ["GF"] },
      { name: "Lamb", price: "13.00", labels: ["GF"] },
      { name: "King Prawn", price: "15.00", labels: ["GF"] },
  ...
  naan: [
    ...
    { name: "Garlic Chilli Naan", price: "4.75", labels: ["veg", "spice-1"] },
  ...
  sides: [
    ...
    { name: "Chana Masala", price: "6.00", desc: "Chickpeas", labels: ["veg"] },
  ...
  chips: [
    ...
    { name: "Peri-Peri Chips", price: "3.75", labels: ["veg", "spice-2"] },
    { name: "Chilli Chips", price: "4.75", labels: ["veg", "spice-2"] },
  ...
  sisterPubsSpecials: [
    { pub: "The Queen Elizabeth", dish: "Chicken Sekuwa" },
    { pub: "The Old Crown", dish: "Karara" },
    { pub: "The White Horse", dish: "Buff Chowmein" },
    { pub: "The Corner House", dish: "Special Veggie Tarkari" },
    { pub: "The Prince of Wales", dish: "Farsi Chiken / Lamb / Veg" },
    { pub: "The Bell", dish: "Methi Chicken / Lamb / Veg" },
    { pub: "The Barley Mow", dish: "Babari Chicken / Lamb / Veg" },
    { pub: "The Railway", dish: "Achari Chicken / Lamb / Veg" },
  ],
}
