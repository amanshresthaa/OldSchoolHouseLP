...
export function InlineBookingCta({
  ...
  return (
    <section className="bg-tertiary-container text-white" {...props}>
      <div className="mx-auto max-w-[84rem] px-5 py-8 sm:px-6 md:px-8 lg:py-10">
        <div className="grid gap-5 lg:grid-cols-[minmax(0,1.04fr)_minmax(19rem,0.96fr)] lg:gap-8">
          <div className="space-y-2.5">
            <p className="text-xs font-semibold tracking-[0.22em] text-[var(--color-on-tertiary-container)] uppercase">
              Book ahead
            </p>
            <h2 className="text-white">{title}</h2>
            <p className="max-w-2xl text-sm leading-6 text-white/75 md:text-base md:leading-7">
              {description}
            </p>
          </div>
