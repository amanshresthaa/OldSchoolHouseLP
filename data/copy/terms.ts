// ---------------------------------------------------------------------------
// data/copy/terms.ts — Terms page
// ---------------------------------------------------------------------------

// ── Terms page ────────────────────────────────────────────────────────────

export const termsHeroCopy = {
  eyebrow: "Terms",
  title:
    "If you are booking, checking the menu, or looking up details for today, here is the short version.",
  description:
    "The website is here to help you plan, but some things still need a quick word with the pub. This page keeps that simple.",
  primaryActionLabel: "Call with a booking question",
  secondaryActionLabel: "Email the team",
}

export const termsShortVersionSectionCopy = {
  eyebrow: "Short version",
  title: "Use the site to plan. Use the pub to confirm.",
  description:
    "That is the easiest way to think about bookings, menus, opening hours, and anything time-sensitive.",
  body: "If the answer affects your visit today, a quick call is always the safest route. If your question is about privacy or cookies, the separate privacy page explains that in plain language too.",
}
...
export const termsSignoffCopy = {
  eyebrow: "Need a clear answer today?",
  title:
    "Use the site to plan, then use the pub to confirm anything time-sensitive.",
  description:
    "That is the simplest way to think about bookings, menu changes, and details that affect today’s visit.",
  body: "If you are unsure about a booking, menu item, or opening detail, call or email the team and we will help you get the current answer without guesswork.",
  primaryActionLabel: "Call with a booking question",
  secondaryActionLabel: "Email the team",
}
