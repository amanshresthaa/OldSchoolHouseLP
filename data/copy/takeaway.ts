// ---------------------------------------------------------------------------
// data/copy/takeaway.ts — Takeaway page
// ---------------------------------------------------------------------------

// ── Takeaway page ────────────────────────────────────────────────────────

export const takeawayHeroCopy = {
...
export const takeawayOrderSectionCopy = {
...
export const takeawayComparisonCards = [
  {
  ...
  },
  {
    ...
    description:
      "The live menu is better when you want to jump straight to starters, mixed grills, curries, sides, or desserts without scrolling through a PDF.",
  },
]

export const takeawayInlineCtaCopy = {
  title: "Changed your mind about staying home?",
  description:
    "If collection turns into dinner plans, book a table and come sit with us instead.",
}
