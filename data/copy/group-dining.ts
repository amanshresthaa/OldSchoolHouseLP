// ---------------------------------------------------------------------------
// data/copy/group-dining.ts — Group dining and celebrations page
// ---------------------------------------------------------------------------

import type { FeaturePageSection } from "@/components/site/FeaturePage"

// ── Group dining and celebrations page ─────────────────────────────────────

export const groupDiningSections: FeaturePageSection[] = [
  {
    ...
    cards: [
      {
        ...
        description:
          "Some of you may want the comfort of a pub favourite, others may want to try the Nepalese kitchen. Here, both can sit naturally on the same table.",
      },
      {
      ...
      },
      {
        ...
        description:
          "With 65 covers inside, 60 outside, and both a front garden and courtyard, the venue can handle more than the usual four-seater without making the evening seem over-planned.",
      },
    ],
  },
  {
    ...
    cards: [
      {
        ...
        description:
          "If the group simply needs food, drinks, and a strong place to meet, go straight into the booking flow and keep the planning light. Up to 8 book normally.",
      },
      {
...
export const groupDiningChecklist = {
...
export const groupDiningFaqSection = {
  ...
  faqs: [
    ...
    {
      question: "What if our plans are still a bit bigger or more specific?",
      answer:
...
export const groupDiningInlineCtaCopy = {
  title:
...
export const groupDiningSignoffCopy = {
  eyebrow: "Next step",
  title: "Choose the route that fits the size of the plan.",
  body: "Keep it simple if it is still a straightforward meal. Move into private hire only if the gathering needs more shaping around the details.",
}
