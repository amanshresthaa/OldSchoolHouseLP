...
export const bookBeforeSection = {
  ...
  description:
    "A fast decision is easier when the site explains what kind of place this is, how the menu works, and where you are going.",
}

export const bookSundayCard = {
  title: "Booking for Sunday?",
  description:
    "Start with the Sunday roast page if the weekend visit is the main plan.",
}

export const bookPrivateHireCard = {
  title: "Planning something bigger?",
  description:
    "Use the private hire route if this is more than a straightforward table booking.",
}

export const bookFindUsCard = {
  title: "Need the practical details?",
  description:
    "Check the address, directions, and arrival notes before you set off.",
}
