// ---------------------------------------------------------------------------
// data/copy/events.ts — Events page
// ---------------------------------------------------------------------------
...
export const eventsRouteSection = {
  ...
  title:
    "Public events and private occasions should not compete with each other.",
  description:
    "If your priority is your own guest list rather than the pub calendar, the private hire route is the right next step.",
}

export const eventsLiveSportCard = {
  title: "Live sport",
  description:
    "Use the live sport page if the main draw is the fixture and the table around it.",
}

export const eventsPrivateHireCard = {
  title: "Private hire",
  description:
    "Use private hire for birthdays, wakes, work drinks, and gatherings built around your own group.",
}
